...
public:
  ...
  virtual antlrcpp::Any visitFunction_params(AslParser::Function_paramsContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitNot(AslParser::NotContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitNegExprIdent(AslParser::NegExprIdentContext *ctx) override {
    return visitChildren(ctx);
  }
